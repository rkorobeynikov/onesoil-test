  ...
  return (
    <div className="field-filter">
      <button className="field-filter__button filter-button" type="button">
        <svg className="filter-button__icon" width="16" height="16" fill="none"><path fillRule="evenodd" clipRule="evenodd" d="M10 2a1 1 0 00-1 1v1H2v2h7v1a1 1 0 002 0V6h3V4h-3V3a1 1 0 00-1-1zM5 9a1 1 0 012 0v1h7v2H7v1a1 1 0 11-2 0v-1H2v-2h3V9z" fill="#000"/></svg>
        Filtered
        <span className="filter-button__badge">4 fields</span>
      </button>
      <button className="clear-filter-button" aria-label="Reset filter">
        <svg width="20" height="21" fill="none"><path fillRule="evenodd" clipRule="evenodd" d="M0 10.5c0 5.523 4.477 10 10 10s10-4.477 10-10-4.477-10-10-10-10 4.477-10 10zm14.705-4.705a1 1 0 010 1.414l-3.29 3.291 3.29 3.291a1 1 0 11-1.414 1.414l-3.29-3.291-3.292 3.291a1 1 0 11-1.414-1.414L8.586 10.5l-3.29-3.291a1 1 0 111.413-1.414L10 9.086l3.291-3.291a1 1 0 011.414 0z" fill="#222"/></svg>
      </button>
...
const FieldFilterLabel = (props) => {
  const labels = fieldTypes.map((item, index) => {
    return (
      <li key={index} className="field-types-list__item">
